...
pub struct CosmosAuthV1beta1Params {
    #[serde(rename = "max_memo_characters", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "tx_size_cost_per_byte", skip_serializing_if = "Option::is_none")]
    pub tx_size_cost_per_byte: Option<String>,
    #[serde(rename = "sig_verify_cost_ed25519", skip_serializing_if = "Option::is_none")]
    pub sig_verify_cost_ed25519: Option<String>,
    #[serde(rename = "sig_verify_cost_secp256k1", skip_serializing_if = "Option::is_none")]
